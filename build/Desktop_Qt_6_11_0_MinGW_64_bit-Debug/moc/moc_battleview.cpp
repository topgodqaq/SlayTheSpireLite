/****************************************************************************
** Meta object code from reading C++ file 'battleview.h'
**
...
#error "The header file 'battleview.h' doesn't include <QObject>."
...
void BattleView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onEnemyClicked((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->onEndTurnClicked(); break;
        case 3: _t->onBattleEnded((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
}
